...
class _GameScreenState extends State<GameScreen> {
  ...
  void initState() {
    ...
    state = GameState(
      ...
      players: [
        Player(name:'ffff', isAI:false, isLiar: true, isSpy: true, level:5, profileImage: "", winRate: 0.62),
        Player(name: '플레이어2', isAI: false, isLiar:false, isSpy: true, level:12, profileImage: "", winRate: 0.5),
        Player(name: '플레이어3', isAI: false, isLiar:false, isSpy: false, level:8, profileImage: "", winRate: 0.46),
        Player(name: 'AI 1', isAI:true, isLiar: true, isSpy: false, level:13, profileImage: "", winRate: 0.71),
        Player(name: 'AI 2', isAI: true, isLiar:false, isSpy: false, level:3, profileImage: "", winRate: 0.49),
        Player(name: 'AI 3', isAI: true, isLiar: false, isSpy: false, level:19, profileImage: "", winRate: 0.81),
      ],
      votes: [],
    );
